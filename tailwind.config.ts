    ...
    extend: {
      ...
      colors: {
        ...
        vault: {
          ...
          "gold-dim": "hsl(var(--vault-gold-dim))",
          bronze: "hsl(var(--vault-bronze))",
          surface: "hsl(var(--vault-surface))",
          "surface-elevated": "hsl(var(--vault-surface-elevated))",
          glow: "hsl(var(--vault-glow))",
        },
        status: {
          loved: "hsl(var(--status-loved))",
          medium: "hsl(var(--status-medium))",
          disliked: "hsl(var(--status-disliked))",
          watchlist: "hsl(var(--status-watchlist))",
        },
        sidebar: {
